...
<img src="../images/query_plan.png" width=80% height=80%>
      
How do we reason about reconciling`collecting different tuples from other tables into a final result` records from different tables in case of joins. There are two ways :
...
<img src="../images/early_materialization.png" width=80% height=80%>
...
<img src="../images/late_materialization.png" width=80% height=80%>
...
* Key: Attribute involved in the join, Value: The record tuples. Whether you store actual records `early materialization` or just references/offsets to the records `late materialization`.
<img src="../images/hash_join.png" width=80% height=80%>    
