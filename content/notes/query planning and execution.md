...
<img src="../images/query_progress.png" width=70% height=70%>
...
* <img src="../images/iterator_model.png" width=70% height=70%>
...
* <img src="../images/materialization_model.png" width=70% height=70%>
...
* <img src="../images/vectorized_model.png" width=70% height=70%>
...
* Sequential Scan Optimisations:
    ...
    * <img src="../images/zone_maps.png" width=70% height=70%>
...
* <img src="../images/multi_index_scan.png" width=70% height=70%>
* More Readings : 
...
* <img src="../images/expression_evaluation.png" width=70% height=70%>
...
* **Process/Worker**
    * <img src="../images/process_per_worker.png" width=70% height=70%>

* **Thread/Worker**
    * <img src="../images/thread_per_worker.png" width=70% height=70%>

* **Embedded databases**
    * <img src="../images/embedded_dbs.png" width=70% height=70%>
...
* **Inter-Operator Parallelism** : Execute multiple disparate, separate queries simultaneously.
    ...
    * <img src="../images/interquery_parallelism.png" width=70% height=70%>

* **Intra-Operator Parallelism** : Execute operations of a single query/operator parallelly. 
    * <img src="../images/intraquery_parallelism1.png" width=70% height=70%>
    ...
    * The dbms inserts an **exchange operator** into the query to coalesce the results from each thread/worker. There are three types of exchange operator :
        ...
        * <img src="../images/exchange_operator.png" width=70% height=70%>
    * <img src="../images/intraquery_parallelism2.png" width=70% height=70%>
...
* **Bushy Parallelism** : 
    ...
    * <img src="../images/bushy_parallelism.png" width=70% height=70%>
...
* **Multi-disk Parallelism** : 
    ...
    * <img src="../images/multidisk_parallelism.png" width=70% height=70%>
